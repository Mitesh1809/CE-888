...
from reading_sentiment_tweet import get_sentiment_data
...
if __name__ == "__main__":
    train_data, test_data, val_data, mappings = get_sentiment_data()
    ...
    model.save(os.path.join(".", "sentiment_model_final"))
